...
class API {
  ...
  static final String loginTicket =
  ...
  static final String webAppIcons =
  ...
  static final String courseScheduleTeacher =
      "$labsHost/courseSchedule/Tcourse.html";

  static final String courseScheduleCourses =
      "$labsHost/courseSchedule/StudentCourseSchedule";
  static final String courseScheduleClassRemark =
